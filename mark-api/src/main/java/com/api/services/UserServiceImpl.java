...
public class UserServiceImpl implements UserService {
	...
	private User updateValidation(User entity) {
		if (ObjectUtils.isEmpty(entity)) {
			...
			throw new MarkException("Error while updating user.");
		}
		...
		try {
			...
			throw new MarkException("Error while updating user's image.");
		}
	...
	public List<User> getUserEmployeeDetailById(String userId) {
		...
		if (ObjectUtils.isEmpty(userId)) {
			...
			throw new MarkException("User id cannot be null or empty.");
		}
		List<User> users = null;
		User user = this.get(userId);
		if (ObjectUtils.isEmpty(user)) {
			log.error("User not found by given id.");
			throw new MarkException("User not found by given id.");
		}
